...
const App = () => (
  ...
  <ChatBot
    ...
    steps={[
      {
        id: "First",
        message: "Привет! Я чат-бот НГТУ. Готов ответить на Ваши вопросы! Чтобы пройти тест на профессиональную ориентацию, введите Тест. Чтобы получить список всех направлений, введите Все направления. Чтобы получить список всех факультетов, введите Все факультеты",
        trigger: "request"
      },
      {
        id: "request",
